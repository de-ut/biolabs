...
func parseArgs() (args cmdArgs) {
	...
	-h --help							Show help documentation about command line arguments
	-i --input							Input from file or from 2 files. Usage: -i <file_path1> [<file_path2>]
	-o --output							Output to file. Usage:  -o <file_path>
	-g --gap		(default=-2)				Gap and open gap penalty. Usage: -g <value>
	-e --egap		(default=-2)				Extansion gap penalty for Hirschberg algorithm. Usage: -e <value>
	-M --match		(default=1)				Score for symbols match. Usage: -M <value>
	-m --miss		(default=-1)				Score for symbols missmatch. Usage: -m <value>
	-d --dict		(default=false)				Change to comparasion with matrix from file. Usage: -d <matrix_file>
	-nw								Launch Needleman-Wunsch algorithm		
	-anw								Launch Needleman-Wunsch algorithm with affine penalty
	-hirsh								Launch Hirschberg algorithm`
